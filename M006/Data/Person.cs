...
public class Person
{
    ...
    /// </summary>
    public Person(string vorname, string nachname, int alter, Geschlecht geschlecht) : this(vorname, nachname) //Hier wird vorname und nachname nach oben weitergegeben
    {
        Alter = alter;
